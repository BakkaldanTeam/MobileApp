...
window.ParsleyConfig.i18n.en = $.extend(window.ParsleyConfig.i18n.en || {}, {
  defaultMessage: "Hatalı değer",
  type: {
    email:        "Hatalı eposta adresi.",
    url:          "Hatalı URL.",
    number:       "Değer rakam değil.",
    integer:      "Değer tamsayı değil.",
    digits:       "Digit hatalı.",
    alphanum:     "Değer alphanumeric değil."
  },
  notblank:       "Bu alan boş kalamaz.",
  required:       "Bu alan gerekli.",
  pattern:        "Değer Hatalı.",
  min:            "Büyük eşit olmalı, %s.",
  max:            "Küçük eşit olmalı %s.",
  range:          "Arasında olmalı %s ve %s.",
  minlength:      "Değer çok kısa. Daha %s karakter girilmeli.",
  maxlength:      "Değer çok uzun. Fazladan %s karakter var.",
  length:         "Değer uzunluğu hatalı. Değer %s ve %s karakter arası olmalı.",
  mincheck:       "En az  %s seçilmelidir.",
  maxcheck:       "En fazla %s seçilebilir",
  check:          " %s ve %s arası seçim gereklidir.",
  equalto:        "Değerler birbirinin aynısı olmalıdır."
});
